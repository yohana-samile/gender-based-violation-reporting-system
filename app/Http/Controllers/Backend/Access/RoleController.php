...
class RoleController extends  Controller
{
    ...
    public function create()
    {
        ...
        return view('pages.backend.access.role.create', $data);
    }
    ...
    public function edit($roleUid)
    {
        ...
        return view('pages.backend.access.role.edit', $data);
    }
    ...
    public function profile($roleUid) {
        ...
        $data['role'] = $role;
        return view('pages.backend.access.role.profile.profile', $data);
    }
