...
Route::prefix('users')->middleware('access.routeNeedsPermission:all_functions')->group(function () {
    Route::get('/user', [\App\Http\Controllers\Backend\UserCrudController::class, 'index'])->name('backend.user');
    ...
    Route::post('/update/{user}', [\App\Http\Controllers\Backend\UserCrudController::class, 'update'])->name('backend.update.user');
