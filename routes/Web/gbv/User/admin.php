...
Route::prefix('users')->middleware('access.routeNeedsPermission:all_functions')->group(function () {
    ...
    Route::get('/create', [\App\Http\Controllers\Gbv\UserCrudController::class, 'create'])->name('backend.create.user');
    Route::post('/create', [\App\Http\Controllers\Gbv\UserCrudController::class, 'store'])->name('backend.create.user');
    Route::put('/update/{user}', [\App\Http\Controllers\Gbv\UserCrudController::class, 'update'])->name('backend.update.user');
