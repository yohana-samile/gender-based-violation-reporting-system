<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('signup') }}" class="form bg-white w-full">
            @csrf
            ...
            <div class="inputForm mt-5 mb-4">
                ...
                <input placeholder="{{__('Enter your Email')}}" id="email" name="email" class="input bg-white" type="text" :value="old('email')" required />
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                <p class="p">{{__("Already registered? ")}}<span class="span"><a href="{{ route('gbv.dashboard')}}">{{__(' Sign In')}}</a></span>
            </div>
        </form>
