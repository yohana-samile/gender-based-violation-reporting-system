...
@section('content')
        ...
        <div class="flex space-x-2">
            @if(access()->allow('manage_role_and_permissions'))
                <div class="flex justify-end mb-4">
                    <a href="{{ route('backend.role.create') }}" class="px-4 py-2 mb-3 inline-flex items-center text-white bg-indigo-500 hover:bg-indigo-500 rounded">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="table-container relative overflow-x-auto shadow-md sm:overflow-auto">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 nextbyte-table" id="role-table">
