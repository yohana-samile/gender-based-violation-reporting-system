...
@section('content')
    <div class="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-white rounded-md shadow-md">
        <div class="mb-6">
            <h1 class="text-2xl font-bold">Users
                <span class="text-base font-normal ml-2">
                <a href="{{ route('backend.user') }}" class="text-blue-600 dark:text-purple-400 hover:underline">
            ...
            <div class="grid grid-cols-1 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $user->name) }}" required
                           class="w-full px-3 py-2 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded focus:outline-none focus:ring focus:border-blue-500 dark:text-white">
                </div>
                        ...
                        @foreach($permissions as $permission)
                            <label class="inline-flex items-center space-x-2">
                                <input type="checkbox" name="permissions[]" value="{{ $permission->name }}"
                                       ...
                                       class="form-checkbox text-green-600 dark:bg-gray-800 dark:border-gray-600">
