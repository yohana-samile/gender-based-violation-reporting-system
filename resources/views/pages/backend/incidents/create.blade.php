        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('backend.incident.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-8">
                        ...
                        <div class="mb-8" id="victims-section">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button type="button" id="add-victim" class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                    Add Another Victim
                                </button>
                            </div>
                            ...
                            <div class="victim-form space-y-4">
                                ...
                                <div class="victim border border-gray-200 p-4 rounded-lg">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <!-- Name -->
                                        <div>
                                            <label for="victims[0][name]" class="block text-sm font-medium text-gray-700">Name</label>
                                        ...
                                        <!-- Gender -->
                                        <div>
                                            <label for="victims[0][gender]" class="block text-sm font-medium text-gray-700">Gender</label>
                                        ...
                                        <!-- Age -->
                                        <div>
                                            <label for="victims[0][age]" class="block text-sm font-medium text-gray-700">Age</label>
                                        ...
                                        <!-- Contact Number -->
                                        <div>
                                            <label for="victims[0][contact_number]" class="block text-sm font-medium text-gray-700">Contact Number</label>
                                            <input type="text" name="victims[0][contact_number]" id="victims[0][contact_number]"
                                                   class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>

                                        <!-- Contact Email -->
                                        <div>
                                            <label for="victims[0][contact_email]" class="block text-sm font-medium text-gray-700">Contact Email</label>
                                            <input type="email" name="victims[0][contact_email]" id="victims[0][contact_email]"
                                                   class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                    </div>
                                    ...
                                    <!-- Address -->
                                    <div class="mt-4">
                                        <label for="victims[0][address]" class="block text-sm font-medium text-gray-700">Address</label>
                        ...
                        <div class="mb-8" id="perpetrators-section">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button type="button" id="add-perpetrator" class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        ...
                        <div class="mb-8" id="evidence-section">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button type="button" id="add-evidence" class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                    Add More Evidence
                                </button>
                            </div>
