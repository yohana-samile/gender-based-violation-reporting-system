                ...
                <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50 pb-8">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between w-full">
                        ...
                        <div class="flex flex-shrink-0 space-x-4">
                            ...
                            @endif
                            <a href="{{ route('backend.incident.index') }}"
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                                ...
                                <div class="space-y-4">
                                    @foreach($incident->victims as $victim)
                                        <div
                                                class="border border-gray-200 p-5 rounded-lg hover:shadow-md transition-shadow duration-200">
                                        ...
                                        @foreach($incident->evidence as $evidence)
                                            <div
                                                ...
                                                <div class="flex justify-between items-start mb-3">
                                                    ...
                                                    <a href="{{ route('backend.incident.view', $evidence->uid) }}" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm flex items-center">
                                                ...
                                                @endif
                                                <p class="text-xs text-gray-500 mt-2">File
                                                    type: {{ strtoupper($evidence->file_type) }}</p>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                        ...
                        <div class="space-y-6 w-full">
                            @if (access()->allow('case_worker'))
                                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                                    ...
                                    <form action="{{ route('backend.incident.update-status', $incident->uid) }}"
                                          method="POST">
                                        @csrf
                                        <div class="space-y-4">
                                            <div>
                                            ...
                                            <div>
                                                <label for="update_text"
                                                       class="block text-sm font-medium text-gray-700 mb-1">Update
                                                    Notes</label>
                                                <textarea name="update_text" id="update_text" rows="3"
                                                          class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                                          placeholder="Add update notes..." required></textarea>
                                            </div>
                                            <button type="submit"
                                ...
                                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                                    ...
                                    <form action="{{ route('backend.incident.attach-services', $incident->uid) }}"
                                          method="POST">
                                        @csrf
                                        <div class="space-y-4">
                                            <div class="mb-4">
                                                ...
                                                <select name="service_ids[]" id="service_ids" multiple
                                                        class="mt-1 block w-full select2-multiple">
                                            ...
                                            <div>
                                                ...
                                                <textarea name="notes" id="notes" rows="2"
                                                          class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                                          placeholder="Add notes about services..."></textarea>
                                            </div>
                                            <button type="submit"
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                                class="text-sm font-medium">{{ $incident->created_at->diffForHumans() }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-600">Occurred</span>
                                        <span
                                                class="text-sm font-medium">{{ $incident->occurred_at->diffForHumans() }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                                class="text-sm font-medium">{{ $incident->supportServices->count() }}</span>
                                    </div>
                                    <div class="flex justify-between">
