                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="space-y-8">
                        @foreach($incidentsByStatus as $status => $incidents)
                            <div class="incident-section bg-gray-50 p-4 rounded-lg">
                                <div class="flex justify-between items-center mb-4">
                                    <h4 class="text-md font-medium capitalize">{{ str_replace('_', ' ', $status) }}
                                        ({{ count($incidents) }})</h4>
                                    <button onclick="exportSectionToExcel(this)"
                                            data-section="{{ str_replace(' ', '_', $status) }}"
                        ...
                        @foreach($incidentsByType as $type => $incidents)
                            <div class="incident-section bg-gray-50 p-4 rounded-lg">
                                <div class="flex justify-between items-center mb-4">
                                    <h4 class="text-md font-medium capitalize">{{ str_replace('_', ' ', $type) }}
                                        ({{ count($incidents) }})</h4>
                                    <button onclick="exportSectionToExcel(this)"
                                            data-section="{{ str_replace(' ', '_', $type) }}"
                                            class="text-sm text-blue-600 hover:text-blue-800 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                  d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
