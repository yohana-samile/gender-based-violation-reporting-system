...
@section('content')
    <div class="py-6">
        <div class="flex justify-between mb-6">
            ...
            <a href="{{ route('gbv.incident.create') }}"
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">
                                        <a href="{{ route('incidents.show', $incident->uid) }}"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('gbv.incident.show', $incident->uid) }}"
                                       class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                                    @if (access()->allow('case_worker'))
                                        <a href="{{ route('gbv.incident.edit', $incident->uid) }}"
                                           class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                                        <form action="{{ route('gbv.incident.destroy', $incident->uid) }}" method="POST"
