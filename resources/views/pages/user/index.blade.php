...
@section('content')
    ...
    <div class="table-container overflow-hidden sm:overflow-auto">
        <table class="mt-5 mb-3 w-full bg-white rounded-lg nextbyte-table" id="whm-customers">
            <thead>
    ...
    <div id="customerDetailsModal" class="fixed inset-0 bg-opacity-50 hidden flex items-center justify-center z-50">
        <div class="bg-gray-100 p-6 rounded-lg shadow-lg max-w-md w-full relative">
    ...
    <div id="updateCustomerDetails" class="fixed inset-0 bg-opacity-50 hidden flex items-center justify-center z-50">
        <div class="bg-gray-100 p-6 rounded-lg shadow-lg max-w-4xl w-full relative">
            <button onclick="closeModal('updateCustomerDetails')"
                    class="absolute top-2 right-2 text-gray-600 hover:text-gray-900">
                <i class="fas fa-times text-xl"></i>
            </button>
