        ...
        <form class="mt-5 mx-auto" id="createAdminForm" method="POST" action="{{ route('backend.create.user') }}">
            ...
            <div class="mb-8">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center border border-gray-300 rounded-lg p-2 mt-1 @error('name') border-red-500 @enderror">
                        <input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="{{ __('name') }}" class="w-full bg-transparent focus:outline-none" required>
                    </div>
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center border border-gray-300 rounded-lg p-2 mt-1 @error('email') border-red-500 @enderror">
                        <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="{{ __('Enter email') }}" class="w-full bg-transparent focus:outline-none" required>
                    </div>
                    @error('email')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <div class="flex items-center border border-gray-300 rounded-lg p-2 mt-1 @error('password') border-red-500 @enderror">
                            <input id="new_password" type="password" name="password" placeholder="{{ __('new password') }}" class="w-full bg-transparent focus:outline-none" minlength="8" required>
                        </div>
                        @error('password')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
