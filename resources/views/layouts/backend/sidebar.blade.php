...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    <nav class="mt-5">
        <x-nav-link href="{{ route('backend.dashboard') }}" :active="request()->routeIs('backend.dashboard')" class="flex items-center py-2 px-3 rounded hover:bg-gray-200 dark:hover:bg-gray-700">
            <i class="fas fa-tachometer-alt mr-3 text-gray-600 dark:text-gray-300"></i>
            {{ __('Dashboard') }}
        </x-nav-link>
{{--        @if (access()->allow('all'))--}}

        <x-nav-link href="{{ route('backend.incident.index') }}" :active="request()->routeIs('backend.incident.index')" class="flex items-center py-2 px-3 rounded hover:bg-gray-200 dark:hover:bg-gray-700">
            <i class="fas fa-users mr-3 text-gray-600 dark:text-gray-300"></i>
            {{ __('Incidents') }}
        </x-nav-link>

        <x-nav-link href="{{ route('backend.incident.reports') }}" :active="request()->routeIs('backend.incident.reports')" class="flex items-center py-2 px-3 rounded hover:bg-gray-200 dark:hover:bg-gray-700">
            <i class="fas fa-users mr-3 text-gray-600 dark:text-gray-300"></i>
            {{ __('Reports') }}
        </x-nav-link>
